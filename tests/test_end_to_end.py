"""Quick end-to-end smoke test against Liyana's EEG.

Run with:
    python -m tests.test_end_to_end /Volumes/INTENSO/NKT/EEG2100/FA06301E.EEG
"""
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        # Default for Liyana's recording
        path = "/Volumes/INTENSO/NKT/EEG2100/FA06301E.EEG"
    else:
        path = sys.argv[1]
    main(path)
